...
class Cpanel extends BaseController
{
    ...
    public function fingerPrintforEmp()
    {
        ...
        // var_dump($data);die;
        echo view('attends/fingerPrint_emp_print', $data);
    }
    ...
    public function fingerPrint()
    {
        ...
        if (is_null($month_numeric) || is_null($year) || empty($month_numeric) || empty($year)) {
            ...
            if ($fp_type === 'overtime') {
                echo view('attends/fingerprint_ot_print', $data);
            } else {
                echo view('attends/fingerprint_print', $data);
            }
        }
    }
    ...
    public function monthlyCoverList_form()
    {
        ...
        if (is_null($month_numeric) || is_null($year) || empty($month_numeric) || empty($year)) {
            ...
            if($db_table === 'before'){
                    return redirect()->to(base_url('cpanel/monthlyCoverList?' . $query));
                ...
                $data['attends'] = $attends = $this->attendModel->getAttend($filters);

                if($fp_type === 'basic'){
                    echo view('attends/coverlist_form', $data);
                }elseif ($fp_type === 'overtime'){
                    echo view('attends/coverlist_ot_form', $data);
                }else{
    ...
    public function monthlyCoverList_save()
    {
        ...
        return redirect()->to(base_url('cpanel/monthlyCoverList?' . $query))->with('success', 'Saved successfully');
    }
    ...
    public function monthlyCoverList()
    {
        ...
        if (is_null($month_numeric) || is_null($year) || empty($month_numeric) || empty($year)) {
            ...
            if ($fp_type == "basic") {
                ...
                if ($db_table == "before") {
                    echo view('attends/coverlist_before_print', $data);
                }
                elseif ($db_table == "after") {
                    ...
                    echo view('attends/coverlist_print', $data);
                }
            } elseif ($fp_type == "overtime") {
                if ($db_table == "before") {
                    echo view('attends/coverlist_ot_before_print', $data);
                } elseif ($db_table == "after") {
                    ...
                    echo view('attends/coverlist_ot_print', $data);
                }
            } else {
                echo "Invalid Fingerprint Type";
            }
    ...
    public function exportToExcel()
    {
        ...
        $attends = $this->attendModel->getAttend($filters);
        if (empty($attends)) {
