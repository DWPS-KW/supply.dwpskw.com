    ...
    <div class="page-container bg-white text-black">
        ...
        <table class="table table-striped main-attendance-table text-black" dir="ltr">
            <thead class="table-header-group">
                <tr>
                    <th colspan="10" class="text-center pb-2 arabic-section">
            ...
            <tbody class="tbody" dir="ltr">
                ...
                <tr>
                    ...
                    <td class="table-cell-custom table-data-cell-left" style="text-align: left;"><?= esc(ucwords(strtolower($emp->name_english))); ?></td>
                    ...
                    <td class="table-cell-custom text-center">
                        <?php
                        $working_days = $emp->coverlist_working_days ?? null;
                    ...
                    <td class="table-cell-custom text-center">
                        <?php
                        $no_of_med = isset($emp->coverlist_med_days) ? $emp->coverlist_med_days : null;
                    ...
                    <td class="table-cell-custom text-center">
                        <?php
                        $no_of_abs = isset($emp->coverlist_absent_days) ? $emp->coverlist_absent_days : null;
                    ...
                    <td class="table-cell-custom text-center">
                        <?php
                        $leaves_days = $emp->coverlist_leave_days ?? null;
                        if ($leaves_days === 0 || strtolower($leaves_days) === 'n/a' || $leaves_days === '0') {
                            echo '';
                        } else {
                            echo esc($leaves_days);
                        }
                        ?>
                    </td>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="10" class="text-center fs-3 p-3 table-cell-custom">
            ...
            <tfoot class="table-footer-group" dir="rtl">
                <tr>
                    <td colspan="10" class="pt-4" style="border: none;">
                ...
                <tr>
                    <td colspan="10" style="border: none;" class="text-center">
